        ...
        for pagenum in range(1):
            ...
            if test1:
                ...
                #print ASX_Code
                    ...
                    #sh_Confirmation = ((re.search("[Uncheck|Check]", str(test3.pop(0)).replace(" ", "")).group(0).lower()))#.replace("uncheck","N")).replace("check", "Y")
                    sh_Confirmation = ((re.search("[Uncheck|Check]", str(test3.pop(0)).replace(" ", "")).group(0).lower())).replace("u","N")).replace("c", "Y").replace("h", "Y")
