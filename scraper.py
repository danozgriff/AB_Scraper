...
scraperwiki.sqlite.execute("create table Signal_History (`ASX code` varchar2(8) PRIMARY KEY NOT NULL, `Date` date PRIMARY KEY NOT NULL, `Price` real NOT NULL, `Signal` varchar2(15) NOT NULL, `Confirmation` char(1) NOT NULL, `AUD 100` real NOT NULL)")
