...
scraperwiki.sqlite.execute("create table Signal_History (`ASX code` varchar2(8), `Date` date, `Price` integer, `Signal` varchar2(15), `Confirmation` char(1), `AUD 100` integer)")
